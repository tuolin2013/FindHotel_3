...
public class MyProfileActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ExitApplication.getInstance().addActivity(MyProfileActivity.this);
		menu = new MyActionMenu(MyProfileActivity.this).initView();
		initActionBar();
	}
	...
	void initActionBar() {
		String title = getResources().getString(R.string.title_activity_my_profile);
