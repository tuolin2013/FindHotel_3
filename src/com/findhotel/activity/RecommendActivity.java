...
import com.findhotel.R.layout;
import com.findhotel.R.menu;
import com.findhotel.activity.WantGoActivity.MyPagerAdapter;
...
public class RecommendActivity extends SherlockFragmentActivity {
	SlidingMenu menu;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ExitApplication.getInstance().addActivity(RecommendActivity.this);
		setContentView(R.layout.activity_recommend);
		menu = new MyActionMenu(RecommendActivity.this).initView();
		initView();
	...
	void initActionBar() {
		String title = getResources().getString(R.string.title_activity_professional_go);
